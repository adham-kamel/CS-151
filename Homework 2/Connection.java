...
public class Connection {
	...
	private void resetConnection() {
		...
		phone.speak(ACCESS_PROMPT);
	}

	private void chooseAction(String key){
		if (key.equals("1")){
			state = RECORDING;
	...
	private static final int INITIAL_ACTION = 7;

	private static final String ACCESS_PROMPT = "To leave a message, press (1), to access your mailbox, press (2)";
